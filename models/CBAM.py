...
model_urls = {
    "cbam_resnet18": "https://download.pytorch.org/models/resnet18-5c106cde.pth",
    "cbam_resnet34": "https://download.pytorch.org/models/resnet34-333f7ec4.pth",
    "cbam_resnet50": "https://download.pytorch.org/models/resnet50-19c8e357.pth"
}
...
def ResidualNet(arch, network_type, depth, num_classes, att_type, pretrained=True):
...
def cbam_resnet18(num_classes, pretrained=True, **kwargs):
    model = ResidualNet('cbam_resnet18', 'ImageNet', 18, 1000, 'CBAM')
...
def cbam_resnet50(num_classes, pretrained=False, **kwargs):
