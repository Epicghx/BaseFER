...
model_urls = {
    "bam_resnet18": "https://download.pytorch.org/models/resnet18-5c106cde.pth",
    "bam_resnet34": "https://download.pytorch.org/models/resnet34-333f7ec4.pth",
    "bam_resnet50": "https://download.pytorch.org/models/resnet50-19c8e357.pth"
}
...
def bam_resnet18(num_classes, pretrained=True, **kwargs):
    model = ResidualNet('bam_resnet18', 'ImageNet', 18, 1000, 'BAM')
...
def bam_resnet50(num_classes, pretrained=True, **kwargs):
